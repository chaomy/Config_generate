...
# @Last Modified time: 2018-08-13 18:20:20
...
class gn_md_infile(object):
    ...
    def write_md_thermo_expand(self, *args, **kwargs):
    ...
    def gn_md_minimize_cfg(self, config_file=None, fix=None):
...
print "Lattice_constanty = ${lengthy}"
    ...
    def gn_md_lattice(self, config_file=None):
